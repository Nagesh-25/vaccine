...
export async function POST(request: NextRequest) {
  try {
    ...
    const BOT_TOKEN = process.env.TELEGRAM_BOT_TOKEN || "8096396730:AAEmHbo2asHNPWKaiJL8aswdJMg64w-OLqA";
    const CHAT_IDS = process.env.TELEGRAM_CHAT_IDS?.split(',') || ["1617730988", "6752039692" , "6335321259"];
